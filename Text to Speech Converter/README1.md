This project is a simple web app that converts text to speech. It uses modern web technologies to create an interactive experience with colorful animations.
